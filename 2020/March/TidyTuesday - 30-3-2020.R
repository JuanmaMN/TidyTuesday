...
p<-plot_usmap(data = data2, values = "value", labels = TRUE, lines = "white", label_color = "white") + 
  ...
  labs(x = "",y = "",
       title = "Beer Production - States with the highest number barrels produced in 2019 ",
       subtitle = "	California - state with the highest number of barrels - Type: On Premises	.",
